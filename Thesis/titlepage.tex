...
%
    ...
    \begin{center}
        \vspace*{1.53cm}
        {\fontfamily{phv}\selectfont\large
        \uppercase{\textbf{master's/bachelor's/doctoral thesis}}
    ...
    \begin{flushleft}
        \textbf{Faculty of Technical Physics, Computer Science and Applied Mathematics}\\
        \textbf{Supervisor: Title Name Surname}\\
        \textbf{Student: Title \theauthor}\\
        \textbf{Student no.: 999999}\\
        \textbf{Field of study: Computer Science and Information Technology}
    \end{flushleft}
    \end{adjustwidth}

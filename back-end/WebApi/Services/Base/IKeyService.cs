...
namespace OpenOsp.WebApi.Services {
  ...
  public interface IKeyService<T, TKey> : IService<T>
  ...
  public interface IKeyService<T, TKey1, TKey2> : IService<T>
  ...
  public interface IKeyService<T, TKey1, TKey2, TKey3> : IService<T>
